...
public:
	...
	virtual void DataIn(uint8 nOffset, uint8* pMainBuf, Spare* pSpare, bool bFull = true) = 0;
	virtual NErr DataOut(uint8 nOffset, uint8* pMainBuf, Spare* pSpare, bool* pbFull = nullptr) = 0;
